-- Users
INSERT OR IGNORE INTO users (name, birth_date, taj_num, remarks) VALUES
...
INSERT OR IGNORE INTO medical_certificates (user_id, issued_at, expires_at) VALUES
...
INSERT OR IGNORE INTO psychological_certificates (user_id, issued_at, expires_at) VALUES
...
-- Insurances
INSERT OR IGNORE INTO insurances (user_id, issued_at, expires_at, payment) VALUES
